...
def get_model_prediction(minutes: float, three_point_attempts: float, opponent: str):
    ...
    prompt = f"Combien de 3 points va marquer Stephen Curry en jouant {minutes} minutes avec {three_point_attempts} tirs à 3 points contre {opponent}?"
...
if __name__ == "__main__":
    def run_fastapi():
        uvicorn.run(app, host="0.0.0.0", port=8001)  # Use a different port for FastAPI
